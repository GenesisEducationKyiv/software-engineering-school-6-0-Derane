...
/**
 * Contract for the single handler that answers a given query.
 *
 ...
 * the narrowing is Psalm-only. These generics deliver AC #3 "no mixed leak across
 * the bus boundary" — they are required, not decoration.
 *
 * @template T of Query
