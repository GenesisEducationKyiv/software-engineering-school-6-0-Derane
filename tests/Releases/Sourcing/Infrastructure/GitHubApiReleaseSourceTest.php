...
namespace Tests\Releases\Sourcing\Infrastructure;

use App\Releases\Sourcing\Domain\RateLimitException;
use App\Releases\Sourcing\Infrastructure\Cache\NullGitHubCache;
...
final class GitHubApiReleaseSourceTest extends TestCase
{
    private function createServiceWithMock(array $responses): GitHubApiReleaseSource
    {
